        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Somos un grupo de jóvenes amantes de los videojuegoss y de la
                        programación.</p>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 order-md-1">
                ...
                <div id="carouselImages" class="carousel slide">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#arouselImages"
                            data-bs-slide="prev">
            ...
            <div class="col-md-6 order-md-2">
                ...
                <div class="d-grid gap-3 col-10 mx-auto">
                    ...
                    <button class="btn btn-outline-primary" type="button"
                            oneclick="addProducto(<?php echo $id; ?>, '<?php echo $token_tmp; ?>')">Agregar al carrito
                    </button>
